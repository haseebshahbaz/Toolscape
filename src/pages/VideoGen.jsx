      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            Create videos automatically with AI-powered video generation. This tool enables you to generate engaging and dynamic videos effortlessly, perfect for marketing, tutorials, or presentations.
            </Typography>
            <Button
              variant="contained"
              style={{
